...
This folder contains **Skill** documents: compact, high-signal “rules of engagement” for this template’s stack.
...
- Search (Elasticsearch): `SKILL_SEARCH_ELASTICSEARCH.md`
- Events / CDC / Kafka: `SKILL_EVENTS_CDC_KAFKA.md`
